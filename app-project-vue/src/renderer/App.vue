      ...
      <el-header class="app-header">
        <div class="app-header__left">
          ...
          <el-tooltip :content="isCollapse ? '展开侧边栏' : '收起侧边栏'" placement="top">
            <i
              class="iconfont icon-menu text-primary cursor-pointer"
              ...
              <ul class="tab-ul">
                ...
                >
                  ...
                  >
                    ...
                    <i
                      class="iconfont icon-close tab-li-icon text-primary"
            ...
            >
              ...
              <template v-else>
                ...
                <el-submenu index="goods">
                  ...
                  <el-menu-item
                    index="goodsCategoryList"
                    :route="{ name: 'goodsCategoryList' }"
                  >类别管理</el-menu-item>
                </el-submenu>
                <el-submenu index="logistics">
                  ...
                  <el-menu-item
                    index="deliveryTimeType"
                    :route="{ name: 'deliveryTimeTypeList' }"
                  >送货时间</el-menu-item>
                </el-submenu>
              ...
              <el-row class="app-page-header__row">
                <el-col :span="12">
                  <el-breadcrumb separator-class="el-icon-arrow-right">
                    ...
                    <el-breadcrumb-item
                      v-for="item in $route.meta && $route.meta.breadcrumbs"
                      :key="item.name"
                    >
                    ...
                    >{{$route.meta && ($route.meta.breadcrumbTitle || $route.meta.title)}}</el-breadcrumb-item>
                  </el-breadcrumb>
                </el-col>
...
const adjustTabLayout = (el, binding) => {
  if (binding.value !== binding.oldValue) {
    ...
    if (activeTabLiElement) {
      ...
      const distance =
        appTabContentWidth - activeTabLiElementWidth - activeTabLiElementLeft;
      const showSwitchTab =
        tabUlElementWidth < appTabContentWidth ? "hidden" : "visible";
...
export default {
  ...
  mounted() {
    window.addEventListener("resize", () => {
      adjustTabLayout(document.querySelector(".app-tab"), {
        value: this.activeTabIndex
      });
      adjustToolsLayout(document.querySelector(".app-page-tools"), {
      ...
      handler(currentRoute = {}, prevRoute = {}) {
        ...
        if (currentRouteName === "login") {
          ...
          if (!this.keepAliveNames.includes(currentRouteName)) {
            ...
            if (
              !this.keepAliveNamesMap[currentTabKey].includes(currentRouteName)
            ) {
          ...
          if (
            prevRouteMeta &&
            !prevRouteMeta.isMainPage &&
            prevTabKey === currentTabKey &&
            prevRouteNameIndex >= 0
          ) {
            const index = this.keepAliveNamesMap[prevTabKey].indexOf(
              prevRouteName
            );
