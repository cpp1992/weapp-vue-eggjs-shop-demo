...
if (userType === "admin") {
  ...
  const merchantDefaultBreadcrumbs = {
    breadcrumbs: [{ title: "商家管理", name: "merchantList" }]
  };
  ...
  const accountDefaultBreadcrumbs = {
    breadcrumbs: [{ title: "账号信息", name: "merchantView" }]
  };
  const orderDefaultMeta = { title: "订货单", tabKey: Constants.ORDER };
  const orderDefaultBreadcrumbs = {
    breadcrumbs: [{ title: "订货单", name: "orderList" }]
  };
  const goodsCategoryDefaultMeta = {
    title: "类别管理",
    tabKey: Constants.GOODS_CATEGORY
  };
  const goodsDefaultMeta = { title: "商品管理", tabKey: Constants.GOODS };
  const goodsDefaultBreadcrumbs = {
    breadcrumbs: [{ title: "商品管理", name: "goodsList" }]
  };
  const freightPlanDefaultMeta = {
    title: "运费方案",
    tabKey: Constants.FREIGHT_PLAN
  };
  const deliveryTimeTypeDefaultMeta = {
    title: "送货时间",
    tabKey: Constants.DELIVERY_TIME_TYPE
  };
