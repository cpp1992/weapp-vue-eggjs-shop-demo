    ...
    <el-row type="flex" :gutter="20">
      <el-col :span="12">
        <el-card class="chart-card">
          ...
          <ve-line
            :data="chartOrderQtyData"
            :settings="chartSettings"
            :extend="chartOrderQtyExtend"
            ref="chartOrderQty"
            :grid="grid"
            :height="chartHeight"
          ></ve-line>
      ...
      <el-col :span="12">
        <el-card>
          ...
          <ve-line
            :data="chartOrderAmountData"
            :settings="chartSettings"
            :extend="chartOrderAmountExtend"
            ref="chartOrderAmount"
            :grid="grid"
            :height="chartHeight"
          ></ve-line>
        </el-card>
    ...
    <el-row type="flex" :gutter="20">
      <el-col :span="12">
        <el-card class="chart-card">
          ...
          <ve-line
            :data="chartGoodsQtyData"
            :settings="chartSettings"
            :extend="chartGoodsQtyExtend"
            ref="chartGoodsQty"
            :grid="grid"
            :height="chartHeight"
          ></ve-line>
      ...
      <el-col :span="12">
        <el-card>
          ...
          <ve-line
            :data="chartOrderReceiptAmountData"
            :settings="chartSettings"
            :extend="chartOrderAmountExtend"
            ref="chartOrderReceiptAmount"
            :grid="grid"
            :height="chartHeight"
          ></ve-line>
        </el-card>
  ...
  methods: {
    ...
    async getForWeek() {
      ...
      Object.entries(res).forEach(item => {
        ...
        chartOrderReceiptAmountDataRows.push({
          日期: day,
          金额: paymentAmount
        });
      });
